...
static const char *yazicmd[] = {"st", "yazi", NULL};
...
static const Key keys[] = {
	...
	{ 0,                XF86XK_AudioRaiseVolume,    spawn,    SHCMD("amixer -q sset Master 5%+ && kill -44 $(pidof dwmblocks)") },
    	...
    	{ 0,                XK_Print,            spawn, SHCMD("scrot '/tmp/%F_%T_$wx$h.png' -s --freeze -e 'xclip -selection clipboard -target image/png -i $f'") },
    	{ MODKEY,           XK_Print,            spawn, SHCMD("scrot  ~/Pictures/Screenshots/%d-%m-%y\ %H:%M:%S.png --freeze -s") },
    	{ ShiftMask,                    XK_Print,            spawn, SHCMD("scrot '/tmp/%F_%T_$wx$h.png' -e 'xclip -selection clipboard -target image/png -i $f'") },
    	{ MODKEY|ShiftMask,                    XK_Print,            spawn, SHCMD("scrot  ~/Pictures/Screenshots/%d-%m-%y\ %H:%M:%S.png") },
	TAGKEYS(                        XK_1,                                  0)
	TAGKEYS(                        XK_2,                                  1)
	TAGKEYS(                        XK_3,                                  2)
	TAGKEYS(                        XK_4,                                  3)
...
static const Button buttons[] = {
	...
	{ ClkClientWin,         MODKEY|ShiftMask,    	     Button2,        dragmfact,      {0} },
